...
aloha_luau = Event.create(name: 'Aloha Luau', address: '4300 Maui Rd, Honolulu, HI 96814', description: 'Enjoy an relaxing luau with free drinks and food', date: '2019/04/02', time: '3:00PM', itinerary: hawaii_itinerary)

pineapple_tour = Event.create(name: 'Pineapple Farm Tour', address: '200 Pineapple Dr, Honolulu, HI 96812', description: 'Check out how pineapples are grown in Hawaii & enjoy delicious dole whip!', date: '2019/04/03', time: '1:00PM', itinerary: hawaii_itinerary)
...
hollywood_tour = Event.create(name: 'Hollywood Walk of Fame Tour', address: '700 Hollywood Drive, Hollywood, CA 90211', description: 'Find the hand prints of your favorite celebrities!', date: '2019/05/02', time: '12:00PM', itinerary: cali_itinerary)
