...
hawaii_itinerary = Itinerary.create(destination_name: 'Hawaii', destination_address: '1200 Hawaii Street, Honolulu, HI 96814', airline: 'Hawaiian Airlines', airport_code: 'HNL', flight_number: '200', gate_number: '1A', seat_number: '15B', departure_date: '2019-04-01', return_date: '2019-04-03', user: josie, receiver: cory)
...
cali_itinerary = Itinerary.create(destination_name: 'California', destination_address: '200 Rodeo Drive, Beverly Hills, CA 90210', airline: 'Delta Airlines', airport_code: 'LAX', flight_number: '100', gate_number: '11A', seat_number: '10C', departure_date: '2019-05-01', return_date: '2019-05-02', user: sam, receiver: jane)
